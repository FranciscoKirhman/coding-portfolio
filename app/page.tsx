...
const projects: Project[] = [
  ...
  { title: 'PlantFinder', year: '2024', eyebrow: 'Science utility', description: 'A Chilean plant-species query tool designed to explore species, distribution, and plant type.', tags: ['HTML', 'Node.js', 'Oracle'], repo: 'https://github.com/FranciscoKirhman/PlantFinder', accent: 'from-green-300 via-emerald-400 to-teal-400' },
  { title: 'NutriCal', year: '2024', eyebrow: 'Nutrition utility', description: 'A macro- and micronutrient calculator conceived around dietary guidelines and portion calculations.', tags: ['HTML', 'Node.js', 'Oracle'], repo: 'https://github.com/FranciscoKirhman/NutriCal', accent: 'from-yellow-200 via-amber-300 to-orange-300' },
  { title: 'BiopREL', year: '2023', eyebrow: 'Research analysis', description: 'GelMA hydrogel analysis comparing gelatin sources and modification degrees, including Young’s modulus visualisations.', tags: ['Python', 'Tableau', 'Research'], repo: 'https://github.com/FranciscoKirhman/BiopREL', demo: 'https://public.tableau.com/app/profile/francisco.kirhman.osorio/vizzes', accent: 'from-pink-300 via-fuchsia-300 to-purple-400' },
];
